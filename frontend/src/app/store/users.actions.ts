...
export const facebookLoginUserRequest = createAction('[Users] Fb Login Request', props<{userData: LoginSocialUserData}>());
export const facebookLoginUserSuccess = createAction('[Users] Fb Login Success', props<{user: User}>());
export const facebookLoginUserFailure = createAction('[Users] Fb Login Failure', props<{error: null | LoginError}>());

export const googleLoginUserRequest = createAction('[Users] Google Login Request', props<{userData: LoginSocialUserData}>());
export const googleLoginUserSuccess = createAction('[Users] Google Login Success', props<{user: User}>());
export const googleLoginUserFailure = createAction('[Users] Google Login Failure', props<{error: null | LoginError}>());
